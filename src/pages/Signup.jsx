...
const Signup = () => {
  ...
  return (
    <section
      id="signup"
      className="min-h-screen bg-gradient-to-br from-softpink via-cream to-softpink flex items-center justify-center p-4 py-30"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/10 rounded-full animate-pulse"></div>
        <div className="absolute top-1/3 -left-16 w-32 h-32 bg-brown/10 rounded-full animate-bounce"></div>
        <div className="absolute bottom-1/3 -right-8 w-24 h-24 bg-primary/20 rounded-full animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 border-2 border-lightgrey/30 rounded-2xl shadow-2xl transform transition-all duration-500 hover:scale-105 hover:shadow-3xl animate-fadeInUp">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2 animate-slideInFromLeft delay-500">
              <label
        ...
        <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-gradient-to-r from-primary to-orange-500 rounded-full opacity-20 animate-pulse delay-1000"></div>
      </div>
    </section>
  );
};
